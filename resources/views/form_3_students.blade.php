            ...
            <tbody>
                ...
                <tr class="border-b hover:bg-gray-50">
                    ...
                    <td class="py-3 px-4 text-sm text-gray-700">
                       <a href="edit_form3/{{$user->id}}"> <button class="bg-blue-500 text-white px-2 py-1 rounded-md hover:bg-blue-600">Edit</button></a>
                       <a href="delete_form3/{{$user->id}}"> <button class="bg-red-500 text-white px-1 py-1 rounded-md hover:bg-red-600">Delete</button></a>
                       <a href="view_form3/{{$user->id}}"> <button class="bg-green-500 text-white px-2 py-1 rounded-md hover:bg-red-600">View</button></a>
