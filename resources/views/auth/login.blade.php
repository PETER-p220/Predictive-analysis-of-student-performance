...
<div class="bg-white font-[sans-serif] min-h-screen flex flex-col items-center justify-center py-6 px-4">
      <div class="max-w-md w-full border p-8 rounded-md bg-gray-100">
        ...
        <div class="relative flex items-center">
          ...
          <div class="relative flex items-center">
            <input name="password" type="password" required class="w-full text-sm text-gray-800 bg-white border-2 border-transparent focus:border-[#1E2772] pl-4 pr-8 py-3 rounded-md outline-none" placeholder="Enter password" />
